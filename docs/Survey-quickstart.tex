...
Open your analysis tool of choice and download your raw survey data as a
csv and load it into your
...
\CommentTok{#read/store the data as the variable df (short for dataframe)}
\NormalTok{df }\OperatorTok{=}\NormalTok{ pd.read_csv(filename)}
\end{Highlighting}
\end{Shaded}
