...
\NormalTok{  squirrel <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(file, }\DataTypeTok{n_max =} \DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{names}\NormalTok{()}
  
\NormalTok{  squirrel_}\DecValTok{2}\NormalTok{ <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(file, }\DataTypeTok{col_names =}\NormalTok{ df_names, }\DataTypeTok{skip =} \DecValTok{3}\NormalTok{)}
\NormalTok{\}}
