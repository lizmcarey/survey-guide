...
When you download a csv from Qualtrics, it will come with a few extra rows you don't need. Here are some automated scripts you can add to your makefile to speed up your work =flow 
...
load_qualtrics_csv <- function(file) {
  squirrel <- read_csv(file, n_max = 0) %>% names()
  
  squirrel_2 <- read_csv(file, col_names = df_names, skip = 3)
}
